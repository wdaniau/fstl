...
void Window::on_help() {
    ...
    helpWin->setText(""
                     "<h2>Help</h2>"
                     "<ul><li>"
                     "<a href=\"https://github.com/wdaniau/fstl/tree/fstl-e_dev?tab=readme-ov-file#usage\""
                       "   style=\"color: #93a1a1; font-weight: bold;\">Usage</a> (follow link)"
                     "</li>"
                     "<li>"
                     "<a href=\"https://github.com/wdaniau/fstl/tree/fstl-e_dev?tab=readme-ov-file#known-issues\""
